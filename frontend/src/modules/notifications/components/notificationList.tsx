                ...
                md:gap-0`}>
                    ...
                    md:gap-2.5">
                        ...
                        md:gap-2.5">
                            ...
                            md:text-[18px]
                            px-2 py-1
                            md:px-2.5 md:py-1.25`}>{notification.level.toLowerCase()}</span>
                                <span className="status-pill info font-bold
                            text-[14px]
                            md:text-[18px]
                            px-2 py-1
                            md:px-2.5 md:py-1.25">{notification.electronic
                        ...
                        text-[14px]
                        md:text-[18px]">{notification.message}</p>
                    ...
                    gap-2.5">
                        ...
                        py-1.25 px-2.5 rounded-lg text-[14px] ${notification.is_read ? levelClassButton.read : levelClassButton.unread}
                        md:text-[18px] md:py-2.5 md:px-5
                        hover:shadow-(--shadow-button) hover:bg-(--color-primary-hover)`}>{notification.is_read ? "read" : "mark as read"}</span>
                            <p className="text-(--text-main) font-medium
                        text-[14px]
                        md:text-[18px]">{new Date(notification.created_at).toLocaleDateString("en-US", {
                                year: "numeric",
                                month: "short",
                                day: "numeric",
                            })}</p>
